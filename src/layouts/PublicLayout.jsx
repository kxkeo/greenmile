        ...
        <div className="grid gap-10 md:grid-cols-4">
          <div className="md:col-span-2 max-w-sm">
            ...
            <div className="flex gap-3 mt-5">
              <a href="https://www.facebook.com/profile.php?id=100090212755471" target="_blank" rel="noopener noreferrer"
              ...
              <a href="https://www.instagram.com/thegreenmileboosters" target="_blank" rel="noopener noreferrer"
